...
server.start = function () {
  ...
  app.get(settings.baseAuthPath + 'user/kick/:uid', routes.kickUser);
  app.get(settings.baseAuthPath + 'user/logout/:authtoken', routes.logoutUser);
  app.get(settings.baseAuthPath + 'user/channel/add/:channel/:uid', routes.addUserToChannel);
  app.get(settings.baseAuthPath + 'user/channel/remove/:channel/:uid', routes.removeUserFromChannel);
  app.get(settings.baseAuthPath + 'channel/add/:channel', routes.addChannel);
  ...
  app.get(settings.baseAuthPath + 'channel/remove/:channel', routes.removeChannel);
